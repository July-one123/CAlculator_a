...
Задачи: создать шаблон, проверка,корректировка.
Этапы: создать шаблон, проверка работоспособности, тест на ввод разных данных, исправление ошибок, проверка, если работа программы исправна, то исправлять и проверять, то тех пор пока не будет исключений.
Требованию к конечному продукту: корректно вычислял при вводе нужных знаков и чисел.
Критерии оценки результата: выводит верные данные, проверяет верные ли данные ввели, не выводит ошибок.
